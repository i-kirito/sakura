...
$(function () {
    ...
    console.log("%c ikirito %c", "background:#24272A; color:#ffffff", "", "https://ikirito.xyz/");
    console.log("%c Github %c", "background:#24272A; color:#ffffff", "", "https://github.com/i-kirito");
});
...
function loadBotui() {
    if ($('div').hasClass('popcontainer')) {
        if (mashiro_global.variables.has_bot_ui) {
            ...
            $.getScript('https://cdn.jsdelivr.net/gh/i-kirito/botui@1.3/js/botui.js',
                //上方JS中的'BotUI回复配置'修改为你自己的BotUI回复配置，其他不变
                function() {

                    mashiro_global.variables.has_bot_ui = false
                })
        }
    }
}